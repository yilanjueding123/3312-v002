...
gpCdspWBGain_t *ov9712_awb_r_b_gain_boundary(void)
{
    ...
    ov9712_wbgain.max_rgain = OV9712_r_b_gain[49][0];
    ov9712_wbgain.max_bgain = OV9712_r_b_gain[11][1];
    ov9712_wbgain.min_rgain = OV9712_r_b_gain[11][0];
    ov9712_wbgain.min_bgain = OV9712_r_b_gain[49][1];
