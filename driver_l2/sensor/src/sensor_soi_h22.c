...
gpCdspWBGain_t *soi_h22_awb_r_b_gain_boundary(void)
{
    ...
    soi_h22_wbgain.max_rgain = g_H22_r_b_gain[49][0];
    soi_h22_wbgain.max_bgain = g_H22_r_b_gain[11][1];
    soi_h22_wbgain.min_rgain = g_H22_r_b_gain[11][0];
    soi_h22_wbgain.min_bgain = g_H22_r_b_gain[49][1];
