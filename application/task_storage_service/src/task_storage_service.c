...
void task_storage_service_entry(void *para)
{
    ...
    while(1)
    {
        ...
        case MSG_STORAGE_SERVICE_VIDEO_FILE_DEL:
            ...
            break;
        case MSG_STORAGE_SERVICE_COPY:
            msgQSend(ApQ, MSG_APQ_COPY_CARD_REPLAY, NULL, NULL, MSG_PRI_NORMAL);
            break;
        ...
        case MSG_STORAGE_SERVICE_TIMER_START:
            ...
            if(storage_service_para[0] == 0x55)
                ap_storage_service_timer_start1();
