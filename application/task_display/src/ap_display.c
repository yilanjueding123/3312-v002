...
INT8U * 		display_frame[DISPLAY_BUF_NUM_MAX] =
{
	0
};


INT32U			display_dma_queue[DISPLAY_BUF_NUM_MAX] =
{
	0
};


// FIFO of display buffer address
INT32U			display_isr_queue[DISPLAY_BUF_NUM_MAX] =
{
	0
};
...
static DISPLAY_REC_TIME display_total_time =
{
	0
};
...
static DISPLAY_ICONSHOW display_icon_item[ICOM_MAX_NUM] =
{
	...
	{
		32, 32, TRANSPARENT_COLOR, TFT_WIDTH - 40, TFT_HEIGHT - 35
	},
	...
	// ICON_PLAYBACK
	{
		32, 32, TRANSPARENT_COLOR, 50, 0
	},

	// ICON_BASE_SETTING
	{
		32, 32, TRANSPARENT_COLOR, 2, 0 + C_ICON_OFF_Y * 2
	},

	// ICON_MOTION_DETECT
	{
		32, 32, TRANSPARENT_COLOR, 40, 0
	},

	// ICON_REC
	{
		32, 32, TRANSPARENT_COLOR, 0, 188
	},
	...
	// ICON_PAUSE					//for VGA
	{
		32, 32, TRANSPARENT_COLOR, 128, 0
	},

	// ICON_MIC_OFF
	{
		32, 32, TRANSPARENT_COLOR, 130, 10
	},

	// ICON_IR_ON, not used
	{
		64, 64, TRANSPARENT_COLOR, 128, 88
	},

	// ICON_FOCUS, not used
	{
		32, 32, TRANSPARENT_COLOR, TFT_WIDTH - 40, 0
	},

	// ICON_VIDEO
	{
		32, 32, TRANSPARENT_COLOR, TFT_WIDTH - 40, 160
	},
	...
	// ICON_NO_SD_CARD
	{
		32, 32, TRANSPARENT_COLOR, 2, 0 + C_ICON_OFF_Y * 1
	},
	...
	{
		32, 32, TRANSPARENT_COLOR, 2, 0 + C_ICON_OFF_Y * 3
	},
	...
	{
		256, 128, TRANSPARENT_COLOR, 32, 40
	},

	// ICON_USB_CONNECT
	{
		16, 96, TRANSPARENT_COLOR, 10, 72
	},

	// ICON_SCROLL_BAR
	{
		8, 8, TRANSPARENT_COLOR, 14, 149
	},

	// ICON_SCROLL_BAR_IDX
	{
		32, 32, TRANSPARENT_COLOR, 10, 168
	},

	// ICON_MP3_PLAY				//27 MP3 icon start
	{
		32, 32, TRANSPARENT_COLOR, 10, 168
	},
	...
	// ICON_MP3_PAUSE
	{
		32, 32, TRANSPARENT_COLOR, 42, 168
	},
	...
	// ICON_MP3_PLAY_ALL
	{
		128, 32, TRANSPARENT_COLOR, 10, 200
	},

	// ICON_MP3_INDEX
	{
		32, 32, TRANSPARENT_COLOR, 74, 168
	},
	...
	{
		32, 32, TRANSPARENT_COLOR, 2 + 38 * 2 - 5, 0
	},
	...
	{
		32, 32, TRANSPARENT_COLOR, 2, 0 + C_ICON_OFF_Y * 5
	},
	...
	{
		32, 32, TRANSPARENT_COLOR, 78, 0
	},

	// ICON_CAPTURE_ANTI_SHAKING
	{
		32, 32, TRANSPARENT_COLOR, 78 + 38, 0
	},

	// ICON_CAPTURE_SEQUENCE
	{
		32, 32, TRANSPARENT_COLOR, TFT_WIDTH - 40, 0 + C_ICON_OFF_Y * 2
	},
	...
	{
		64, 32, TRANSPARENT_COLOR, 2, 210 - 5
	},
	...
	// ICON_PLAYBACK_MOVIE,
	{
		32, 32, TRANSPARENT_COLOR, 2, 210 - 5 - 35
	},

	// ICON_PLAYBACK_VOLUME_TITLE,
	{
		32, 32, TRANSPARENT_COLOR, 2 + 30 + C_ICON_VOL_OFFSET * 0, 210 - 5 - 35
	},

	// ICON_PLAYBACK_VOLUME_WHITE1,
	{
		32, 32, TRANSPARENT_COLOR, 2 + 30 + C_ICON_VOL_OFFSET * 1, 210 - 5 - 35
	},

	// ICON_PLAYBACK_VOLUME_WHITE2,
	{
		32, 32, TRANSPARENT_COLOR, 2 + 30 + C_ICON_VOL_OFFSET * 2, 210 - 5 - 35
	},

	// ICON_PLAYBACK_VOLUME_WHITE3,
	{
		32, 32, TRANSPARENT_COLOR, 2 + 30 + C_ICON_VOL_OFFSET * 3, 210 - 5 - 35
	},

	// ICON_PLAYBACK_VOLUME_WHITE4,
	{
		32, 32, TRANSPARENT_COLOR, 2 + 30 + C_ICON_VOL_OFFSET * 4, 210 - 5 - 35
	},

	// ICON_PLAYBACK_VOLUME_WHITE5,
	{
		32, 32, TRANSPARENT_COLOR, 2 + 30 + C_ICON_VOL_OFFSET * 5, 210 - 5 - 35
	},

	// ICON_PLAYBACK_VOLUME_WHITE6,
	{
		32, 32, TRANSPARENT_COLOR, 2 + 30 + C_ICON_VOL_OFFSET * 6, 210 - 5 - 35
	},

	// ICON_PLAYBACK_VOLUME_WHITE7,
	{
		32, 32, TRANSPARENT_COLOR, 2 + 30 + C_ICON_VOL_OFFSET * 7, 210 - 5 - 35
	},
	...
	{
		32, 32, TRANSPARENT_COLOR, 280, 0
	},

	// ICON_AUDIO_RECORD
	{
		32, 32, TRANSPARENT_COLOR, 55, 210
	},
	...
	// ICON_4X
	{
		32, 32, TRANSPARENT_COLOR, 100, 210
	},
	...
	//	{ 32,  32, TRANSPARENT_COLOR,	130, 100}//ICON_NULL
};
...
static DISPLAY_ICONSHOW display_tv_icon_item[ICOM_MAX_NUM] =
{
	...
	{
		32, 32, TRANSPARENT_COLOR, TV_WIDTH - 75, TV_HEIGHT - 50
	},
	...
	// ICON_BASE_SETTING
	{
		32, 32, TRANSPARENT_COLOR, 35, 25 + C_ICON_OFF_Y_TV * 2
	},

	// ICON_MOTION_DETECT,	#
	{
		32, 32, TRANSPARENT_COLOR, 100, 25
	},

	// ICON_REC,						#
	{
		32, 32, TRANSPARENT_COLOR, 35, 400
	},
	...
	// ICON_PAUSE			//for VGA,	#
	{
		32, 32, TRANSPARENT_COLOR, 150, 25
	},

	// ICON_MIC_OFF,					#
	{
		32, 32, TRANSPARENT_COLOR, 130, 25
	},
	...
	// ICON_FOCUS, not used
	{
		32, 32, TRANSPARENT_COLOR, TV_WIDTH - 75, 25
	},

	// ICON_VIDEO,				#
	{
		32, 32, TRANSPARENT_COLOR, TV_WIDTH - 75, TV_HEIGHT - 120
	},
	...
	// ICON_NO_SD_CARD,			#
	{
		32, 32, TRANSPARENT_COLOR, 35, 25 + C_ICON_OFF_Y_TV * 1
	},
	...
	// ICON_VIDEO_RECORD_CYC_10MINUTE,	#
	{
		32, 32, TRANSPARENT_COLOR, 35, 25 + C_ICON_OFF_Y_TV * 3
	},
	...
	// ICON_VIDEO_EV_6,	#
	{
		32, 32, TRANSPARENT_COLOR, 35, TV_HEIGHT - 120
	},
	...
	// ICON_BATTERY_CHARGED,	#
	{
		32, 32, TRANSPARENT_COLOR, 200, 25
	},
	...
	// ICON_CAPTURE_WHITE_BALANCE_FLUORESCENT,	#
	{
		32, 32, TRANSPARENT_COLOR, 35, 25 + C_ICON_OFF_Y_TV * 5
	},
	...
	// ICON_CAPTURE_ANTI_SHAKING,	#
	{
		32, 32, TRANSPARENT_COLOR, 160, 25
	},

	// ICON_CAPTURE_SEQUENCE,		#
	{
		32, 32, TRANSPARENT_COLOR, TV_WIDTH - 75, 25 + C_ICON_OFF_Y_TV * 2
	},
	...
	// ICON_CAPTURE_QUALITY_ECONOMY,	#
	{
		64, 32, TRANSPARENT_COLOR, 35, TV_HEIGHT - 80
	},
	...
	// ICON_PLAYBACK_VOLUME_TITLE,							#
	{
		32, 32, TRANSPARENT_COLOR, 35 + 30 + C_ICON_VOL_OFFSET_TV * 0, TV_HEIGHT - 120
	},

	// ICON_PLAYBACK_VOLUME_WHITE1,	#
	{
		32, 32, TRANSPARENT_COLOR, 35 + 30 + C_ICON_VOL_OFFSET_TV * 1, TV_HEIGHT - 120
	},

	// ICON_PLAYBACK_VOLUME_WHITE2,	#
	{
		32, 32, TRANSPARENT_COLOR, 35 + 30 + C_ICON_VOL_OFFSET_TV * 2, TV_HEIGHT - 120
	},

	// ICON_PLAYBACK_VOLUME_WHITE3,	#
	{
		32, 32, TRANSPARENT_COLOR, 35 + 30 + C_ICON_VOL_OFFSET_TV * 3, TV_HEIGHT - 120
	},

	// ICON_PLAYBACK_VOLUME_WHITE4,	#
	{
		32, 32, TRANSPARENT_COLOR, 35 + 30 + C_ICON_VOL_OFFSET_TV * 4, TV_HEIGHT - 120
	},

	// ICON_PLAYBACK_VOLUME_WHITE5,	#
	{
		32, 32, TRANSPARENT_COLOR, 35 + 30 + C_ICON_VOL_OFFSET_TV * 5, TV_HEIGHT - 120
	},

	// ICON_PLAYBACK_VOLUME_WHITE6,	#
	{
		32, 32, TRANSPARENT_COLOR, 35 + 30 + C_ICON_VOL_OFFSET_TV * 6, TV_HEIGHT - 120
	},

	// ICON_PLAYBACK_VOLUME_WHITE7,	#
	{
		32, 32, TRANSPARENT_COLOR, 35 + 30 + C_ICON_VOL_OFFSET_TV * 7, TV_HEIGHT - 120
	},
...
static DISPLAY_ICONSHOW display_tv_icon_item[ICOM_MAX_NUM] =
{
	...
	{
		32, 32, TRANSPARENT_COLOR, TV_WIDTH - 50, TV_HEIGHT - 55
	},
	...
	// ICON_BASE_SETTING
	{
		32, 32, TRANSPARENT_COLOR, 20, 25 + C_ICON_OFF_Y_TV * 2
	},
	...
	// ICON_REC,						#
	{
		32, 32, TRANSPARENT_COLOR, 20, 400
	},
	...
	// ICON_FOCUS, not used
	{
		32, 32, TRANSPARENT_COLOR, TV_WIDTH - 50, 25
	},

	// ICON_VIDEO,				#
	{
		32, 32, TRANSPARENT_COLOR, TV_WIDTH - 50, TV_HEIGHT - 120
	},
	...
	// ICON_NO_SD_CARD,			#
	{
		32, 32, TRANSPARENT_COLOR, 20, 25 + C_ICON_OFF_Y_TV * 1
	},
	...
	// ICON_VIDEO_RECORD_CYC_10MINUTE,	#
	{
		32, 32, TRANSPARENT_COLOR, 20, 25 + C_ICON_OFF_Y_TV * 3
	},
	...
	// ICON_VIDEO_EV_6,	#
	{
		32, 32, TRANSPARENT_COLOR, 20, TV_HEIGHT - 120
	},
	...
	// ICON_CAPTURE_WHITE_BALANCE_FLUORESCENT,	#
	{
		32, 32, TRANSPARENT_COLOR, 20, 25 + C_ICON_OFF_Y_TV * 5
	},
	...
	// ICON_CAPTURE_SEQUENCE,		#
	{
		32, 32, TRANSPARENT_COLOR, TV_WIDTH - 50, 25 + C_ICON_OFF_Y_TV * 2
	},
	...
	// ICON_CAPTURE_QUALITY_ECONOMY,	#
	{
		64, 32, TRANSPARENT_COLOR, 20, TV_HEIGHT - 60
	},
	...
	// ICON_PLAYBACK_VOLUME_TITLE,							#
	{
		32, 32, TRANSPARENT_COLOR, 20 + 30 + C_ICON_VOL_OFFSET_TV * 0, TV_HEIGHT - 120
	},

	// ICON_PLAYBACK_VOLUME_WHITE1,	#
	{
		32, 32, TRANSPARENT_COLOR, 20 + 30 + C_ICON_VOL_OFFSET_TV * 1, TV_HEIGHT - 120
	},

	// ICON_PLAYBACK_VOLUME_WHITE2,	#
	{
		32, 32, TRANSPARENT_COLOR, 20 + 30 + C_ICON_VOL_OFFSET_TV * 2, TV_HEIGHT - 120
	},

	// ICON_PLAYBACK_VOLUME_WHITE3,	#
	{
		32, 32, TRANSPARENT_COLOR, 20 + 30 + C_ICON_VOL_OFFSET_TV * 3, TV_HEIGHT - 120
	},

	// ICON_PLAYBACK_VOLUME_WHITE4,	#
	{
		32, 32, TRANSPARENT_COLOR, 20 + 30 + C_ICON_VOL_OFFSET_TV * 4, TV_HEIGHT - 120
	},

	// ICON_PLAYBACK_VOLUME_WHITE5,	#
	{
		32, 32, TRANSPARENT_COLOR, 20 + 30 + C_ICON_VOL_OFFSET_TV * 5, TV_HEIGHT - 120
	},

	// ICON_PLAYBACK_VOLUME_WHITE6,	#
	{
		32, 32, TRANSPARENT_COLOR, 20 + 30 + C_ICON_VOL_OFFSET_TV * 6, TV_HEIGHT - 120
	},

	// ICON_PLAYBACK_VOLUME_WHITE7,	#
	{
		32, 32, TRANSPARENT_COLOR, 20 + 30 + C_ICON_VOL_OFFSET_TV * 7, TV_HEIGHT - 120
	},
...
static DISPLAY_ICONSHOW display_hdmi_icon_item[ICOM_MAX_NUM] =
{
	...
	{
		64, 64, TRANSPARENT_COLOR_YUYV, 1180 - C_ICON_HDMI_OFFSET, 640
	},

	// ICON_BATTERY_0	//hdmi use
	{
		64, 64, TRANSPARENT_COLOR_YUYV, 1180 - C_ICON_HDMI_OFFSET, 640
	},

	// ICON_BATTERY_1	//hdmi use
	{
		64, 64, TRANSPARENT_COLOR_YUYV, 1180 - C_ICON_HDMI_OFFSET, 640
	},

	// ICON_BATTERY_2	//hdmi use
	{
		64, 64, TRANSPARENT_COLOR_YUYV, 1180 - C_ICON_HDMI_OFFSET, 640
	},

	// ICON_BATTERY_3	//hdmi use
	{
		32, 32, TRANSPARENT_COLOR, 2, 0
	},
	...
	// ICON_VIDEO_RECORD
	{
		64, 64, TRANSPARENT_COLOR_YUYV, 30 + C_ICON_HDMI_OFFSET, 20
	},

	// ICON_PLAYBACK			//hdmi use
	{
		32, 32, TRANSPARENT_COLOR, 50, 0
	},
	...
	// ICON_VIDEO
	{
		32, 32, TRANSPARENT_COLOR, 280, 160
	},
	...
	// ICON_VIDEO_EV_6
	{
		32, 32, TRANSPARENT_COLOR, 128 + 50, 0
	},
	...
	// ICON_BATTERY_CHARGED		//hdmi use
	{
		32, 32, TRANSPARENT_COLOR, 2 + 38 * 2, 0
	},

	// ICON_LOCKED
	{
		64, 64, TRANSPARENT_COLOR_YUYV, 500, 20
	},

	// ICON_LOCKED1				//hdmi use
	{
		32, 32, TRANSPARENT_COLOR, 2, 0 + C_ICON_OFF_Y * 1
	},
	...
	// ICON_CAPTURE_SEQUENCE
	{
		32, 32, TRANSPARENT_COLOR, 280, 0 + C_ICON_OFF_Y * 2
	},
	...
	// ICON_CAPTURE_QUALITY_ECONOMY
	{
		128, 64, TRANSPARENT_COLOR_YUYV, 30 + C_ICON_HDMI_OFFSET, 580
	},

	// ICON_PLAYBACK_PLAY			//hdmi use
	{
		128, 64, TRANSPARENT_COLOR_YUYV, 30 + C_ICON_HDMI_OFFSET, 580
	},

	// ICON_PLAYBACK_PAUSE,			//hdmi use
	{
		64, 64, TRANSPARENT_COLOR_YUYV, 30 + C_ICON_HDMI_OFFSET, 20
	},

	// ICON_PLAYBACK_MOVIE,			//hdmi use
	{
		64, 64, TRANSPARENT_COLOR_YUYV, 30 + 148 + C_ICON_HDMI_OFFSET, 720 - 80 - 64
	},

	// ICON_PLAYBACK_VOLUME_TITLE,								//hdmi use
	{
		64, 64, TRANSPARENT_COLOR_YUYV, 30 + 212 + C_ICON_HDMI_OFFSET + C_ICON_VOL_OFFSET_HDMI * 0, 720 - 80 - 64
	},

	// ICON_PLAYBACK_VOLUME_WHITE1,		//hdmi use
	{
		64, 64, TRANSPARENT_COLOR_YUYV, 30 + 212 + C_ICON_HDMI_OFFSET + C_ICON_VOL_OFFSET_HDMI * 1, 720 - 80 - 64
	},

	// ICON_PLAYBACK_VOLUME_WHITE2,		//hdmi use
	{
		64, 64, TRANSPARENT_COLOR_YUYV, 30 + 212 + C_ICON_HDMI_OFFSET + C_ICON_VOL_OFFSET_HDMI * 2, 720 - 80 - 64
	},

	// ICON_PLAYBACK_VOLUME_WHITE3,		//hdmi use
	{
		64, 64, TRANSPARENT_COLOR_YUYV, 30 + 212 + C_ICON_HDMI_OFFSET + C_ICON_VOL_OFFSET_HDMI * 3, 720 - 80 - 64
	},

	// ICON_PLAYBACK_VOLUME_WHITE4,		//hdmi use
	{
		64, 64, TRANSPARENT_COLOR_YUYV, 30 + 212 + C_ICON_HDMI_OFFSET + C_ICON_VOL_OFFSET_HDMI * 4, 720 - 80 - 64
	},

	// ICON_PLAYBACK_VOLUME_WHITE5,		//hdmi use
	{
		64, 64, TRANSPARENT_COLOR_YUYV, 30 + 212 + C_ICON_HDMI_OFFSET + C_ICON_VOL_OFFSET_HDMI * 5, 720 - 80 - 64
	},

	// ICON_PLAYBACK_VOLUME_WHITE6,		//hdmi use
	{
		64, 64, TRANSPARENT_COLOR_YUYV, 30 + 212 + C_ICON_HDMI_OFFSET + C_ICON_VOL_OFFSET_HDMI * 6, 720 - 80 - 64
	},

	// ICON_PLAYBACK_VOLUME_WHITE7,		//hdmi use
	{
		64, 64, TRANSPARENT_COLOR_YUYV, 30 + 212 + C_ICON_HDMI_OFFSET + C_ICON_VOL_OFFSET_HDMI * 7, 720 - 80 - 64
	},

	// ICON_PLAYBACK_VOLUME_WHITE8,		//hdmi use
	{
		64, 64, TRANSPARENT_COLOR_YUYV, 30 + 212 + C_ICON_HDMI_OFFSET + C_ICON_VOL_OFFSET_HDMI * 0, 720 - 80 - 64
	},

	// ICON_PLAYBACK_VOLUME_READ1,		//hdmi use
	{
		64, 64, TRANSPARENT_COLOR_YUYV, 30 + 212 + C_ICON_HDMI_OFFSET + C_ICON_VOL_OFFSET_HDMI * 1, 720 - 80 - 64
	},

	// ICON_PLAYBACK_VOLUME_READ2,		//hdmi use
	{
		64, 64, TRANSPARENT_COLOR_YUYV, 30 + 212 + C_ICON_HDMI_OFFSET + C_ICON_VOL_OFFSET_HDMI * 2, 720 - 80 - 64
	},

	// ICON_PLAYBACK_VOLUME_READ3,		//hdmi use
	{
		64, 64, TRANSPARENT_COLOR_YUYV, 30 + 212 + C_ICON_HDMI_OFFSET + C_ICON_VOL_OFFSET_HDMI * 3, 720 - 80 - 64
	},

	// ICON_PLAYBACK_VOLUME_READ4,		//hdmi use
	{
		64, 64, TRANSPARENT_COLOR_YUYV, 30 + 212 + C_ICON_HDMI_OFFSET + C_ICON_VOL_OFFSET_HDMI * 4, 720 - 80 - 64
	},

	// ICON_PLAYBACK_VOLUME_READ5,		//hdmi use
	{
		64, 64, TRANSPARENT_COLOR_YUYV, 30 + 212 + C_ICON_HDMI_OFFSET + C_ICON_VOL_OFFSET_HDMI * 5, 720 - 80 - 64
	},

	// ICON_PLAYBACK_VOLUME_READ6,		//hdmi use
	{
		64, 64, TRANSPARENT_COLOR_YUYV, 30 + 212 + C_ICON_HDMI_OFFSET + C_ICON_VOL_OFFSET_HDMI * 6, 720 - 80 - 64
	},

	// ICON_PLAYBACK_VOLUME_READ7,		//hdmi use
	{
		64, 64, TRANSPARENT_COLOR_YUYV, 30 + 212 + C_ICON_HDMI_OFFSET + C_ICON_VOL_OFFSET_HDMI * 7, 720 - 80 - 64
	},

	// ICON_PLAYBACK_VOLUME_READ8,		//hdmi use
	{
		32, 32, TRANSPARENT_COLOR, 280, 0
	},
...
{
	{
		8, 19, TRANSPARENT_COLOR, NULL, NULL
	},
...
{
	{
		16, 38, TRANSPARENT_COLOR_YUYV, NULL, NULL
	},
...
void drawLine(unsigned short * drawImg, int startx, int starty, int endx, int endy, int colorR, int colorG,
	 int colorB)
{
	int 			t, distance;
...
void ap_display_init()
{
	...
	R_TFT_FBI_ADDR		= (INT32U)
	display_frame[DISPLAY_BUF_NUM - 1];
...
void ap_display_tv_init(void)
{
	...
	if ((ap_display_get_device() == DISP_DEV_HDMI) || (ap_display_get_device() == DISP_DEV_TV))
		return;
	...
	//show "TV" on TFT
	display_tmp_tft_frame = (INT32U)
	gp_malloc_align(TFT_WIDTH * TFT_HEIGHT * 2, 64);

	if (display_tmp_tft_frame == 0)
		DBG_PRINT("allocate TFT temp buffer fail\r\n");
	...
	R_TV_FBI_ADDR		= (INT32U)
	display_frame[TV_DISPLAY_BUF_NUM - 1];
...
void ap_display_hdmi_init(void)
{
	...
	(* ((volatile INT32U *) 0xC01B0008)) = (INT32U)
	display_frame[HDMI_DISPLAY_BUF_NUM - 1];
	...
	///////////////////////  HDMI  Video  ///////////////////////
	R_PPU_ENABLE		=
		 (TFT_SIZE_1280X720 | PPU_FRAME_BASE_MODE | PPU_YUYV_RGBG_FORMAT_MODE | PPU_YUYV_MODE | PPU_YUYV_TYPE3 | (1 << 24));
													// YUYV mode
	R_PPU_MISC			|= (1 << 15);
...
/*
 *Display initial, free resource, flush buffer
 *eliminate global varible and so on.
 *
 */
		...
		if (display_icon_sts[i >> 5] & (1 << (i & 0x1F)))
		{
			if ((i != ICON_REC) || ((i == ICON_REC) && ! (display_rec_time.s & 0x1))) //make the ICON_REC Blink!
			{
				for (y = 0; y < display_tv_icon_item[i].icon_h; y++)
				{
					...
					offset_pixel_tmp	=
						 (display_tv_icon_item[i].pos_y + y) *TV_WIDTH + display_tv_icon_item[i].pos_x;
...
void ap_display_hdmi_draw(INT16U * frame_buff)
{
		...
		if (display_icon_sts[i >> 5] & (1 << (i & 0x1F)))
		{
			if ((i != ICON_REC) || ((i == ICON_REC) && ! (display_rec_time.s & 0x1))) //make the ICON_REC Blink!
			{
				for (y = 0; y < display_hdmi_icon_item[i].icon_h; y++)
				{
					...
					offset_pixel_tmp	=
						 (display_hdmi_icon_item[i].pos_y + y) *HDMI_WIDTH + display_hdmi_icon_item[i].pos_x;
	...
	for (i = 0; i < ICOM_MAX_NUM; i++)
	{
		if (display_icon_sts[i >> 5] & (1 << (i & 0x1F)))
		{
			//if((i != ICON_REC) || ((i == ICON_REC) && !(display_rec_time.s & 0x1))) { //make the ICON_REC Blink!
			offset_pixel_tmp	=
				 (display_hdmi_icon_item[i].pos_y >> 1) * 1280 * 3 + (display_hdmi_icon_item[i].pos_x & ~0x0001);
			...
			for (y = 0; y < display_hdmi_icon_item[i].icon_h; y++)
			{
				...
				for (x = 0; x < (display_hdmi_icon_item[i].icon_w / 2); x++) // x is 4-byte data offset
				{
					...
					//				[V,  Y0,  U,  Y1]
					if (offset_data == display_hdmi_icon_item[i].transparent)
						continue;
...
void ap_display_hdmi_icon_draw(INT16U * frame_buff, INT16U * icon_stream, DISPLAY_ICONSHOW * icon_info)
{
	...
	for (y = 0; y < icon_info->icon_h; y++)
	{
		...
		for (x = 0; x < (icon_info->icon_w / 2); x++) // x is 4-byte data offset
		{
			...
			//				[V,  Y0,  U,  Y1]
			if (offset_data == icon_info->transparent)
				continue;
...
void ap_display_buff_copy_and_draw(INT32U buff_addr, INT16U src_type)
{
	...
	//DBG_PRINT("---src_type=%x---\r\n",src_type);
	if (buff_addr == 0)
		return;

	if (g_Disp_Device == DISP_DEV_HDMI)
		return;

	buff_size			= getDispDevBufSize();

	//temp_video_enc_addr=(INT32U)gp_malloc(256);
	//DBG_PRINT("---buff_size=%d---\r\n",buff_size);
	//DBG_PRINT("---buff_addr=%d---\r\n",buff_addr);
	if (src_type == DISPLAY_BUFF_SRC_SENSOR)
	{
		...
		if ((ap_display_get_device() == DISP_DEV_TFT) && LDWS_Enable_Flag)
		{
			...
			{
				if ((LDWPar.LLcheckFlg && LDWPar.RLcheckFlg && LDWPar.LTP_X <= LDWPar.RTP_X + 10) ||
					 LDWPar.LLAlarmFlg || LDWPar.RLAlarmFlg)
				{
	...
	if (buff_get)
	{
		...
		else 
		{
			...
			if ((display_effect_sts != DISPLAY_NONE_EFFECT) ||
				 (display_mp3_index_sts != DISPLAY_MP3_INDEX_NONE_EFFECT) ||
				 (display_mp3_input_num_sts != DISPLAY_MP3_INPUT_NUM_NONE_EFFECT))
			{
...
#if 0
			INT16U ii;
			buff_get			= buff_get + 320 * 240 * 2 - 64;

			for (ii = 0; ii < 64; ii++)
			{
				temp_video_enc_addr = (* (volatile INT8U *) buff_get);

				//(*(volatile INT32U*) buff_get)=0xff;
				buff_get			= buff_get + 1;
				DBG_PRINT("%x-", temp_video_enc_addr);
			}

			buff_get			= buff_get - 320 * 240 * 2;
#endif
...
void ap_display_effect_draw(INT32U buff_addr)
{
	...
	DBG_PRINT("////display_effect_sts = %d\r\n", display_effect_sts);
	...
	if (display_effect_sts == DISPLAY_PIC_EFFECT || display_effect_sts == DISPLAY_PIC_PREVIEW_EFFECT)
	{
		...
		if (!display_effect_buff)
		{
			display_effect_buff = (INT32U)
			gp_malloc_align(buff_size, 64);
	...
	else if (display_effect_sts == DISPLAY_STRING_EFFECT)
	{
		if (g_Disp_Device == DISP_DEV_TFT) //tft
		{
			...
			if (display_str_background)
			{
				...
				{
					tmp 				=
						 ((((TFT_HEIGHT - icon.icon_h) / 2) +i) *TFT_WIDTH + ((TFT_WIDTH - icon.icon_w) / 2)) << 1;
		...
		else if (g_Disp_Device == DISP_DEV_TV) //TV
		{
			...
			if (display_str_background)
			{
				...
				{
					tmp 				=
						 ((((TV_HEIGHT - icon.icon_h) / 2) +i) *TV_WIDTH + ((TV_WIDTH - icon.icon_w) / 2)) << 1;
...
void ap_display_icon_sts_set(INT32U msg)
{
	...
	for (i = 0; i < 3; i++)
	{
		...
		if (icon_idx)
		{
			display_icon_sts[icon_idx >> 5] |= 1 << (icon_idx & 0x1F); //没组display_icon_sts表示32位可以
		}
	}
}
...
void ap_display_hdmi_rec_time_draw(INT16U * frame_buff, void * time_ptr, INT16U pos_x, INT16U pos_y, INT8U red_flag)
{
	...
	for (i = 0; i < 3; i++)
	{
		...
		if (i < 2)
			pos_x_shift = ap_display_hdmi_digital_draw(frame_buff, NUM_TEXT_COLON, pos_x_shift, pos_y, red_flag);
	}
}
...
void ap_display_rec_date_time_draw_browse(INT16U * frame_buff, INT16U pos_x, INT16U pos_y)
{
	...
	else //TV
	{
		...
		pos_x_shift 		=
			 ap_display_tv_digital_draw(frame_buff, NUM_TEXT_COLON, pos_x_shift, pos_y_shift, red_flag);
	}
...
void ap_display_hdmi_rec_date_time_draw_browse(INT16U * frame_buff, INT16U pos_x, INT16U pos_y)
{
	...
	pos_x_shift 		=
		 ap_display_hdmi_digital_draw(frame_buff, NUM_TEXT_COLON, pos_x_shift, pos_y_shift, red_flag);
