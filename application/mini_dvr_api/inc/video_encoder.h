...
#else
#define JPEG_OUT_BUFFER_LARGE_SIZE	(320*1024)	// It will influence UVC
#define JPEG_OUT_BUFFER_MIDDLE_SIZE	(160*1024)//150
#define JPEG_OUT_BUFFER_SMALL_SIZE	(120*1024)
...
#define JPEG_OUT_BUFFER_SMALL_CNT	0
#endif
#define JPEG_OUT_1080P_LARGE_CNT		17//0
#define JPEG_OUT_1080P_MIDDLE_CNT		0//28
#define JPEG_OUT_1080P_SMALL_CNT		0
