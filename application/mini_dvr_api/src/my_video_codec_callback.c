...
extern void gp_wait_sensor_I2C_complete(void);
...
static INT8U   sensor_init_err = 0;
INT32S video_preview_start(preview_args_t *pPreviewArgs)
{
    ...
    */
    ...
    DBG_PRINT("---sensor_width=%d---\r\n", sensor_width);

    DBG_PRINT("---sensor_height=%d---\r\n", sensor_height);
    //	DBG_PRINT("---display_width=%d---\r\n",display_width);
    //	DBG_PRINT("---display_height=%d---\r\n",display_height);
