...
#define ASCII_draw_char_width	0x0C//0x0b
#define ASCII_draw_char_height	0x15//0x13
...
extern void set_check_flag(INT8U posation, INT8U value);
extern INT8U get_check_flag(INT8U posation);
