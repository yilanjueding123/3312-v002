...
//static INT8U g_setting_copy_choice=0;
...
void ap_setting_sub_menu_draw(INT8U curr_tag)
{
    ...
    DBG_PRINT("select_bar\r\n");
    sub_str.font_type = 0;//0;
    ...
    */
    ...
    case STR_COPY:
        ...
        else if(type == SUB_MENU_DRAW)
        {
            ...
            //g_setting_copy_choice=str->font_color;
        }
        else if(type == FUNCTION_ACTIVE)
        {
            DBG_PRINT("VV\r\n");
            ...
            {
                DBG_PRINT("MM\r\n");
                msgQSend(ApQ, MSG_APQ_COPY_CARD, NULL, NULL, MSG_PRI_NORMAL);
                // Card_trans_loop();
                //OSTimeDly(50);

                //msgQSend(StorageServiceQ, MSG_STORAGE_SERVICE_COPY, NULL, NULL, MSG_PRI_NORMAL);
            }
        }
        break;
    case STR_DELETE:
...
void ap_setting_show_software_version()
{
    ...
    ascii_str.pos_x = ICON_SELECTBOX_SUB_START_X + 50;
    ascii_str.pos_y = 100;
    ascii_str.str_ptr = "JH1234_V001";
    *(ascii_str.str_ptr + 2) = PRODUCT_NUM / 1000 + 0x30;
    *(ascii_str.str_ptr + 3) = (PRODUCT_NUM % 1000) / 100 + 0x30;
    *(ascii_str.str_ptr + 4) = (PRODUCT_NUM % 100) / 10 + 0x30;
    *(ascii_str.str_ptr + 5) = PRODUCT_NUM % 10 + 0x30;
    *(ascii_str.str_ptr + 8) = PROGRAM_VERSION_NUM / 100 + 0x30;
    *(ascii_str.str_ptr + 9) = (PROGRAM_VERSION_NUM % 100) / 10 + 0x30;
    *(ascii_str.str_ptr + 10) = PROGRAM_VERSION_NUM % 10 + 0x30;
    ap_state_resource_string_ascii_draw((INT16U *) setting_frame_buff, &ascii_str, RGB565_DRAW);
