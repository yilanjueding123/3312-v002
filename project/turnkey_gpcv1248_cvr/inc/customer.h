...
#define	FUNCTION_KEY1				    AD_KEY_DETECT_PIN
#define OK_KEY							AD_KEY_DETECT_PIN
#define SOS_KEY							AD_KEY_DETECT_PIN
#define FUNCTION_KEY2                   AD_KEY_DETECT_PIN
#define FUNCTION_KEY3                   AD_KEY_DETECT_PIN
#define FUNCTION_KEY4                   AD_KEY_DETECT_PIN
...
#define USE_PANEL_NAME					PANEL_T27P05_ILI8961//PANEL_T43//PANEL_T27P05_ILI8961//PANEL_T27P05_ILI8961
#define USE_PANEL_SCREEN_PROPOTION		PANEL_SCREEN_PROPOTION_4_3//PANEL_SCREEN_PROPOTION_4_3//PANEL_SCREEN_PROPOTION_16_9
#define USE_SENSOR_NAME		            SENSOR_GC1004//SENSOR_SOI_H22//SENSOR_GC1004//SENSOR_SOI_H22 
...
#define KEY_TYPE						KEY_TYPE10//KEY_TYPE4  
#define PWR_KEY_TYPE					READ_FROM_PIN//READ_FROM_GPIO	
#define PW_KEY						    PWR_KEY0// IO_B9
#define ADP_OUT_PIN                     PWR_KEY1 //IO_B8
#define C_USBDEVICE_PIN   				ADP_OUT_PIN
#define AD_KEY_DETECT_PIN			    ADC_LINE_0
#define AD_BAT_DETECT_PIN			    ADC_LINE_1
#define SCCB_SCL     				    IO_C7//	IO_B4//IO_A9//IO_B4//IO_B4//IO_B4	// Sensor I2C clock pin
#define SCCB_SDA      				    IO_C6//    IO_B5//IO_A10// IO_B5//IO_A10//IO_B5	// Sensor I2C data pin
...
#define AV_IN_DET                     	IO_B5//IO_A13

#define HDMI_IN_DET					    IO_B8// IO_D6// IO_D6
#define HDMI_EN                         IO_C15//IO_C15//IO_C15//IO_C15
#define TFT_BL							IO_D8//IO_C13//IO_D8//IO_A12

#define SPEAKER_EN                      IO_D7// IO_A13
#define IR_CTRL                         IO_F15   //ir light	
#define BATT_CHARGE                     IO_A12

#define LED                             IO_F15
#define LED_RED                      IO_C12//   IO_A15//  IO_B8
#define LED_BLUE                     IO_B0//   IO_A14// IO_B10
#define LED_MAIN                        IO_D5
#define LED_MAIN1                       IO_D4
#define LED_SMALL                       IO_F15
#define I80_TE_PIN						IO_F15
#define POWER_EN                        IO_A8
#define SDC_UPGRADE_ERASE_USER_CONFIG	0
#define PRODUCT_NUM                     3312
